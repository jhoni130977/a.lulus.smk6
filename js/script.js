	...
	$('#movie-list2').html(`
		...
		<div class="spinner-border text-danger" role="status">
			<span class="sr-only">Loading...</span>
						...
						`)
     $.ajax({
        url: 'http://smk-smeatdkosgoro2pdg.sch.id/lulusapismk6/aktifapi.php',
        type: 'get',
        dataType: 'json',
            ...
            if(result.status == "sukses"){
                ...
                $.each(movies, function(i, data){
					...
					$("#form-user").on('submit',(function(e) {
						e.preventDefault();
						$.ajax({
							url: "http://smk-smeatdkosgoro2pdg.sch.id/lulusapismk6/editaktif.php",
							type: "POST",
...
$('#movie-list1').html(``);
 $.ajax({
        url: 'http://smk-smeatdkosgoro2pdg.sch.id/lulusapismk6/tampil5.php',
        type: 'get',
        dataType: 'json',
			data: {
            'id' : $('#search-input').val()
...
function lulus() {
					...
					$("#form-lulus5").on('submit',(function(e) {
						...
						e.preventDefault();						
						$.ajax({
							url: "http://smk-smeatdkosgoro2pdg.sch.id/lulusapismk6/editlulus.php",
							type: "POST",
							data:  new FormData(this),
							contentType: false,
							cache: false,
